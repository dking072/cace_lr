...
if 'SLURM_JOB_CPUS_PER_NODE' in os.environ.keys():
    on_cluster = True
if on_cluster:
    root = "/global/scratch/users/king1305/data/spice-dipep-large.h5"
else:
    root = "/home/king1305/ORBITAL_LABELING/cace_lr/data/spice-dipep-large.h5"

LR = True
logs_name = "cace_dipep_c4_large"
if LR:
    logs_name += "_lr"
else:
    logs_name += "_sr"
...
data = SpiceData(root,cutoff,batch_size=batch_size,test_p=0,in_memory=on_cluster)
